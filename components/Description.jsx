    ...
    <div className="min-h-screen flex items-center justify-center min-w-screen pb-[70px]">
      <div className="mx-10 flex flex-col gap-[51px]">
        ...
        <div className="grid  grid-cols-3 gap-10">
          <motion.div
            className="rounded-3xl flex flex-col justify-between bg-[#3c3c3c] p-5 gap-5"
            initial={{ opacity: 0, y: 100 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ delay: 0, duration: 0.4 }}>
            <p className="text-[16px]">
              <span className="text-gray-300 mb-6 bg-[#1F2123] px-3 py-2 rounded-full text-[14px]">
                Immediate Access
              </span>{" "}
          ...
          <motion.div
            className="rounded-3xl flex flex-col justify-between gap-5 bg-[#3c3c3c] p-5"
            initial={{ opacity: 0, y: 100 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ delay: 0, duration: 0.4 }}>
            <p className="text-[16px]">
          ...
          <motion.div
            className="rounded-3xl gap-5 flex flex-col justify-between bg-[#3c3c3c] p-5"
            initial={{ opacity: 0, y: 100 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ delay: 0, duration: 0.4 }}>
            <p className="text-[16px]">
          ...
          <motion.p
            className="rounded-3xl col-span-3 text-[16px] bg-[#3c3c3c] p-5"
            initial={{ opacity: 0, y: 100 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ delay: 0, duration: 0.4 }}>
            <span className="text-gray-300 mb-6 bg-[#1F2123] px-3 py-2 rounded-full text-[14px]">
